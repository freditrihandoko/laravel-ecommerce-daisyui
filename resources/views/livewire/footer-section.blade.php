          ...
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div class="flex justify-center text-teal-600 sm:justify-start dark:text-teal-300">
                @if($logo)
                  <img src="{{ $logo }}" class="h-16 w-16" alt="">
                @else
                ...
                <ul class="mt-8 space-y-4 text-sm">
                  <li>
                    ...
                    >
                      ...
                      <span class="flex-1 text-gray-700 dark:text-gray-300"> {{ $contact_email }} </span>
                    </a>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span class="flex-1 text-gray-700 dark:text-gray-300">{{ $contact_phone }}</span>
                    </a>
                  </li>
